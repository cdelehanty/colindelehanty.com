...
<MDXContainer containerType="text">
	I worked as a contract photographer supporting Apple Inc. on multiple
	productions, capturing media shot on pre-release versions of the iPhone and
	iPad to demonstrate the capabilities of their new hardware for product
	launches. A highlight from these productions was the selection of three
